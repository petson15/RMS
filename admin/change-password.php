...
<body>
    ...
    <small style="color:red; margin-right:80px; margin-top:20px;"><?php echo $error1; ?></small>

    <form action="change-password.php" method="POST" class="password pass-form">
        <div>
        <label for="current">current password: </label>
        <input type="password" id="current" class="form-control mb-3" placeholder="enter current password" name="current_password" required>  
        </div>
        <div>
        <label for="new" >new password:</label>
        <input type="password" id="new" class="form-control mb-3" placeholder="enter new password" name="new_password" required>
        </div>
        
        <div>
            <label for="confirm">Confirm password: </label>
        <input type="password" id="confirm" class="form-control mb-3" placeholder="confirm password" name="confirm_password" required>
        </div>
        <button class="btn bg-primary py-1 my-2 text-white" type="submit" name="change">
